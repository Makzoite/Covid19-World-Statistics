  ...
  function (_React$Component) {
    ...
    function BarChart(props) {
      ...
      _defineProperty(_assertThisInitialized(_this), "getInfoFromRank", function (name) {
        ...
        var currStyle = _objectSpread({}, _this.props.barStyle, {
          ...
          backgroundColor: _this.state.BGColour[name]//_this.props.colors[name]
        });
    ...
    _createClass(BarChart, [{
      ...
      value: function componentWillReceiveProps(nextProps) {
        if (nextProps.start == "restart") {
          clearInterval(this.state.intervalId);
          this.setState({ idx: 0 });
        }
        if (nextProps.start && this.state.idx + 1 === this.props.timeline.length) {
          clearInterval(this.state.intervalId);
          this.setState({ idx: 0 });
        }
        if (nextProps.start) {
